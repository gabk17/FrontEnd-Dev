<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchEmployee.aspx.cs" Inherits="WebProject.SearchEmployee" %>
...
<body>
   ...
   <nav>
    ...
    <div style="background:#222127; margin:150px 37px 50px 490px; border:3.4px solid #c1a26b; width: 1067px; padding: 5px; color: white;">
        <center>
