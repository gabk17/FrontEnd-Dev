...
<head>
 ...
 <body style="background-image: url('WhiteWood.jpg');">
  <form id="form1" action="JDBCReservationUSer.jsp" method="POST">
    <div style="background:#0061ab; width:2000px; position:fixed; top: -12px; left: -1px; height: 69px; z-index:104;">
    </div>
     <nav>
    <div class="wrapper">
      <div class="logo"><a href="MainPageUser.jsp">TURTLE BEACH</a></div>
  ...
  <div style="position: absolute; top: 18px; left: 20px;">
    ...
    <textarea required name="details" ID="detailsOfIncident"
